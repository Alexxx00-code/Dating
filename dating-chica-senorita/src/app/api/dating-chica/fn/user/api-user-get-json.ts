...
export function apiUserGet$Json(http: HttpClient, rootUrl: string, params?: ApiUserGet$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<UserModel>> {

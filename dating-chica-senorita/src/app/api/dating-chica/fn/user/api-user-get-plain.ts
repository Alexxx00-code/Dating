...
export function apiUserGet$Plain(http: HttpClient, rootUrl: string, params?: ApiUserGet$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<UserModel>> {

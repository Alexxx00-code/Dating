...
class Program
{
    ...
    {
        var _botClient = new TelegramBotClient("7544862344:AAGpAIzdLAe0oAZ2fyczCrRZd-eHcx0_kuY"); // Присваиваем нашей переменной значение, в параметре передаем Token, полученный от BotFather
